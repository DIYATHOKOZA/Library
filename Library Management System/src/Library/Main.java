...
public class Main {
	...
	private static void login(String username, String password, JFrame frame) {
	...
	private static void newuser() {
		...
		JLabel title = title("Create new account");
		title.setBorder(BorderFactory.createEmptyBorder(15, 15, 15, 15));
		title.setFont(new Font("Tahoma", Font.BOLD, 21));
		title.setForeground(Color.decode("#1da1f2"));
		frame.getContentPane().add(title, BorderLayout.NORTH);

		JLabel label0 = label("Username:");
		JLabel label1 = label("Password:");
